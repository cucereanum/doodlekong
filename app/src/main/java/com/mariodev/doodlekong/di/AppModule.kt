...
import com.mariodev.doodlekong.data.remote.ws.CustomGsonMessageAdapter
import com.mariodev.doodlekong.data.remote.ws.DrawingApi
import com.mariodev.doodlekong.data.remote.ws.FlowStreamAdapter
...
import com.mariodev.doodlekong.util.Constants.RECONNECT_INTERVAL
import com.mariodev.doodlekong.util.Constants.USE_LOCALHOST
import com.mariodev.doodlekong.util.Constants.WS_BASE_URL
import com.mariodev.doodlekong.util.Constants.WS_BASE_URL_LOCALHOST
import com.mariodev.doodlekong.util.DispatcherProvider
import com.mariodev.doodlekong.util.clientId
import com.mariodev.doodlekong.util.dataStore
...
object AppModule {
    ...
    fun provideDrawingApi(
        ...
        return Scarlet.Builder().backoffStrategy(LinearBackoffStrategy(RECONNECT_INTERVAL))
            .lifecycle(AndroidLifecycle.ofApplicationForeground(app)).webSocketFactory(
