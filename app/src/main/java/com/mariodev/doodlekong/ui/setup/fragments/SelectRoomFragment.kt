...
import com.mariodev.doodlekong.adapters.RoomAdapter
import com.mariodev.doodlekong.databinding.FragmentSelectRoomBinding
import com.mariodev.doodlekong.ui.setup.SelectRoomViewModel
import com.mariodev.doodlekong.util.Constants.SEARCH_DELAY
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCreateRoom.setOnClickListener {
            findNavController().navigateSafely(
                R.id.action_selectRoomFragment_to_createRoomFragment, Bundle().apply {
        ...
        viewModel.setupEvent.collect { event ->
            when (event) {
                is SelectRoomViewModel.SetupEvent.JoinRoomEvent -> {
                    findNavController().navigateSafely(
                        R.id.action_selectRoomFragment_to_drawingActivity, args = Bundle().apply {
                            putString("username", args.username)
